				...
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="photo"><i class="zmdi zmdi-lock-outline"></i></label>
								<input type="file" id="photo" name="photo" accept="image/*" class="photo-upload" required>
						
							</div>
							<div class="form-group">
								<label for="usertype"><i class="zmdi zmdi-account material-icons-name"></i></label>
								<input type="text" id="usertype" name="usertype" placeholder="User type" required="required"/>
